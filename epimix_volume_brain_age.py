...
demog_dir = home_dir+'/Desktop/epimix_brainager_demog'
brainager_dir = home_dir+'/Desktop/brainager_processed'
...
var_names = ['T$_1$-w', 'EPImix T$_1$-w', 'T$_1$-w EPI$_{FOV}$']
...
plt.xlabel('T$_1$-w scans (litres)',fontsize=lbs)       # labels
plt.ylabel('EPImix scans (litres)',fontsize=lbs)
...
plt.legend()
plt.xlabel("Chronological Age (years)",fontsize=lbs)
plt.ylabel('Grey matter volume (litres)',fontsize=lbs)
...
# GM
plt.figure()
sb.kdeplot(rho_gm[fov_gm_ind], bw_method='scott',color='indigo', label="Grey Matter")
plt.xlabel("Spearman's rho",fontsize=lbs+3,labelpad=10); plt.ylabel("Density",fontsize=lbs+3,labelpad=10)
plt.xticks(dens_x_ticks,fontsize=axs); plt.yticks(dens_y_ticks,fontsize=axs)
if save_fig: plt.savefig(plot_dir+'/kernel_density_gm.svg',bbox_inches='tight') 

# WM
plt.figure()
sb.kdeplot(rho_wm[fov_wm_ind], bw_method='scott',color='royalblue', label="White Matter")
plt.xlabel("Spearman's rho",fontsize=lbs+3,labelpad=10); plt.ylabel("Density",fontsize=lbs+3,labelpad=10)
plt.xticks(dens_x_ticks,fontsize=axs); plt.yticks(dens_y_ticks,fontsize=axs)
if save_fig: plt.savefig(plot_dir+'/kernel_density_wm.svg',bbox_inches='tight') 

# CSF
plt.figure()
sb.kdeplot(rho_csf[fov_csf_ind], bw_method='scott',color='mediumpurple', label="CSF")
plt.xlabel("Spearman's rho",fontsize=lbs+3,labelpad=10); plt.ylabel("Density",fontsize=lbs+3,labelpad=10)
plt.xticks(dens_x_ticks,fontsize=axs); plt.yticks(dens_y_ticks,fontsize=axs)
if save_fig: plt.savefig(plot_dir+'/kernel_density_csf.svg',bbox_inches='tight') 
...
plt.xlim(ax_lim); plt.xticks(ax_ticks,fontsize=axs)     # axis limits and ticks
plt.ylim(ax_lim); plt.yticks(ax_ticks,fontsize=axs)
plt.xlabel('Chronological Age (years)',fontsize=lbs)    # labels
plt.ylabel('Predicted Age (years)',fontsize=lbs)
...
plt.xlim(ax_lim); plt.xticks(ax_ticks,fontsize=axs)     # axis limits and ticks
plt.ylim(ax_lim); plt.yticks(ax_ticks,fontsize=axs)
plt.xlabel('T$_1$-w Pred. Age (years)',fontsize=lbs)
plt.ylabel('EPImix Pred. Age (years)',fontsize=lbs)
...
plt.xlabel('T$_1$-w FoV Pred. Age (years)',fontsize=lbs)
plt.ylabel('EPImix Pred. Age (years)',fontsize=lbs)
...
# GM
plt.figure()
sb.kdeplot(icc_vox_gm[fov_gm_ind], bw_method='scott',color='indigo', label="Grey Matter")
plt.xlabel("ICC",fontsize=lbs+3,labelpad=10); plt.ylabel("Density",fontsize=lbs+3,labelpad=10)
plt.xticks(dens_x_ticks,fontsize=axs); plt.yticks(dens_y_ticks,fontsize=axs)
if save_fig: plt.savefig(plot_dir+'/kernel_density_icc_gm.svg',bbox_inches='tight') 

# WM
plt.figure()
sb.kdeplot(icc_vox_wm[fov_wm_ind], bw_method='scott',color='royalblue', label="White Matter")
plt.xlabel("ICC",fontsize=lbs+3,labelpad=10); plt.ylabel("Density",fontsize=lbs+3,labelpad=10)
plt.xticks(dens_x_ticks,fontsize=axs); plt.yticks(dens_y_ticks,fontsize=axs)
...
# CSF
plt.figure()
sb.kdeplot(icc_vox_csf[fov_csf_ind], bw_method='scott',color='mediumpurple', label="CSF")
plt.xlabel("ICC",fontsize=lbs+3,labelpad=10); plt.ylabel("Density",fontsize=lbs+3,labelpad=10)
plt.xticks(dens_x_ticks,fontsize=axs); plt.yticks(dens_y_ticks,fontsize=axs)
